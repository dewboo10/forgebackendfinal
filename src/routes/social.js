...
const MISSIONS = [
  { id: 'm1', key: 'total_mined', checkpoints: [1000,5000,20000,100000,500000,10000000,100000000,1000000000,10000000000,100000000000], rewards: [500,1500,5000,20000,80000,200000,1000000,5000000,20000000,100000000] },
  { id: 'm2', key: 'blocks_found',checkpoints: [1,5,20,50,100,500],            rewards: [500,2500,8000,20000,50000,200000] },
  { id: 'm3', key: 'ref_count',   checkpoints: [1,5,10,25,50,100],             rewards: [5000,30000,100000,500000,1000000,3000000] },
